...
// Assignment : Program 4 Selection Sort with (DescendingOrder.txt)              //
//===============================================================================//
// What it does -                                                                //
//    This programs purpose isto utiliz selection sort                           //
...
//    the descending order elements from 0- 100000                               //
